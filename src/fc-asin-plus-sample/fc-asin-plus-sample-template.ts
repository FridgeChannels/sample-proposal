...
const bodyMarkup = `
  <main class="asin-page">
    <section class="asin-hero">
      <div class="asin-wrap asin-hero__layout">
        <div class="asin-hero__copy">
          <p class="asin-label">FC ASIN+</p>
          <h1>Make the next purchase happen without search.</h1>
          <p>Every equipped shipment leaves a brand-owned, editable touchpoint in the customer’s home.</p>
        </div>
        <div class="asin-hero__visual" aria-label="A customer opens and uses a Fridge Channel magnet">
          <video class="hero-video" src="/videos/fc-amazon-brb.mp4" autoplay muted loop playsinline controls preload="auto"></video>
        </div>
      </div>
    </section>

    <section class="asin-how">
      <div class="asin-wrap">
    ...
    <section class="asin-value">
      <div class="asin-wrap asin-value__layout">
        <p class="asin-value__number">Value 01</p>
    ...
    <section class="asin-value">
      <div class="asin-wrap asin-value__layout">
        <p class="asin-value__number">Value 02</p>
    ...
    <section class="asin-value">
      <div class="asin-wrap asin-value__layout">
        <p class="asin-value__number">Value 03</p>
    ...
    <section class="asin-value">
      <div class="asin-wrap asin-value__layout">
        <p class="asin-value__number">Value 04</p>
    ...
    <section class="asin-value">
      <div class="asin-wrap asin-value__layout">
        <p class="asin-value__number">Value 05</p>
    ...
    <section class="asin-value">
      <div class="asin-wrap asin-value__layout">
        <p class="asin-value__number">Value 06</p>
    ...
    <section class="asin-fit">
      <div class="asin-wrap asin-fit__layout">
    ...
    <section class="asin-cta">
      <div class="asin-wrap asin-cta__inner">
        <h2>Want to test it on one ASIN?</h2>
        <p>Bring the ASIN, reorder cycle, and monthly volume. We’ll map the first pilot together.</p>
        <div class="asin-code-label"><span>Starting scope</span><strong>1 ASIN</strong></div>
        <a class="asin-button" href="https://calendly.com/billy-fridgechannels/fridge-channel-pilot-meeting">Ask about an FC ASIN+ pilot <span aria-hidden="true">→</span></a>
        <p class="asin-email">Prefer email? <a href="mailto:billy@fridgechannels.com">billy@fridgechannels.com</a></p>
      </div>
    </section>

    <footer class="asin-footer">
      <div class="asin-wrap"><p>BRB credits, attribution, household exposure, customer data, and authorized-channel deployment remain subject to applicable Amazon rules, customer consent, and brand distribution agreements.</p></div>
    </footer>
  </main>
`
...
const pageCss = `
  .asin-page{--amazon-navy:#131921;--amazon-orange:#FF9900;--amazon-link:#007185;--amazon-surface:#F3F3F3;--amazon-border:#E0E0E0;overflow:hidden}
  .asin-wrap{width:min(1280px,calc(100% - 48px));margin:0 auto}
  .asin-page h1,.asin-page h2,.asin-page h3{font-family:var(--leg-font)!important;font-weight:400!important}
  .asin-page h1,.asin-page h2{margin:0;letter-spacing:-.045em;line-height:1.03}
  .asin-label,.asin-value__number{margin:0;color:var(--amazon-orange);font-size:16.4px;font-weight:500;letter-spacing:.12em}

  .asin-hero{min-height:100svh!important;padding:72px 0 96px!important;background:var(--leg-background)!important}
  .asin-hero__layout{display:grid;gap:48px}
  .asin-hero__copy{display:grid;max-width:960px;margin:0 auto;justify-items:center;text-align:center}
  .asin-hero h1{max-width:900px;margin-top:20px;font-size:clamp(3rem,5.2vw,4.1rem)!important}
  .asin-hero__copy>p:last-child{max-width:720px;margin:24px auto 0;color:var(--leg-muted-foreground);font-size:clamp(1.15rem,2vw,1.45rem);line-height:1.5}
  .asin-hero__visual{width:100%;max-width:1180px;margin:0 auto;overflow:hidden;border-radius:var(--leg-radius);background:#fff;box-shadow:0 1px 2px rgba(19,25,33,.08),0 18px 48px rgba(19,25,33,.1)}
  .asin-hero__visual video{display:block;width:100%;aspect-ratio:16/8.4;object-fit:cover;background:#000}
  ...
  .asin-steps{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:24px;margin-top:64px}
  ...
  .asin-steps h3{margin:0 0 10px;font-size:1.25rem;letter-spacing:-.025em}
  .asin-steps p{max-width:24ch;margin:0;color:var(--leg-muted-foreground);font-size:16.4px;line-height:1.5}
  ...
  .asin-value__statement{grid-area:statement;max-width:730px;margin:36px 0 0;color:var(--leg-muted-foreground);font-size:clamp(1.18rem,2vw,1.55rem);line-height:1.48}
  .asin-commerce-visual{grid-area:cue;width:min(100%,680px);margin-top:36px}
  ...
  .asin-search-shell{display:grid;grid-template-columns:1fr 48px;overflow:hidden;border:3px solid var(--amazon-orange);border-radius:8px;background:#fff;color:#757575}
  ...
  .asin-attribution{padding:18px 20px;background:#fff;box-shadow:0 1px 2px rgba(19,25,33,.08),0 8px 24px rgba(19,25,33,.06)}
  ...
  .asin-fit__label{margin:0 0 24px;color:var(--leg-brand);font-size:16.4px;font-weight:500}
  .asin-fit__group ol{counter-reset:fit;display:grid;gap:16px;margin:0;padding:0;list-style:none}
  .asin-fit__group li{counter-increment:fit;display:grid;grid-template-columns:30px 1fr;gap:12px;font-size:16.4px;line-height:1.45}
  ...
  .asin-button{display:inline-flex;min-height:44px;align-items:center;gap:10px;margin-top:20px;padding:8px 10px 8px 20px;border-radius:var(--leg-pill);background:var(--amazon-orange);color:var(--amazon-navy);font-size:16.4px;font-weight:600;text-decoration:none}
  ...
  .asin-footer{padding:28px 0;background:var(--leg-brand-dark);color:color-mix(in oklch,var(--leg-brand-foreground) 44%,transparent)}
  .asin-footer p{max-width:1000px;margin:0;font-size:11px;line-height:1.5}

  @media(max-width:760px){
    .asin-wrap{width:min(100% - 40px,1280px)}
    .asin-hero{min-height:auto!important;padding:48px 0 32px!important}
    .asin-hero__layout{gap:32px}
    .asin-hero h1{font-size:clamp(2.3rem,10vw,2.8rem)!important;line-height:1.06!important}
    .asin-hero__copy>p:last-child{max-width:34ch;margin-top:20px;font-size:16.4px}
    .asin-hero__visual{border-radius:16px}
    .asin-hero__visual video{aspect-ratio:16/9;object-fit:contain}
    .asin-how h2,.asin-fit h2{font-size:clamp(2.05rem,9vw,2.35rem)!important}
    .asin-steps{grid-template-columns:1fr;gap:0;margin-top:44px}
    .asin-steps article{padding:20px 0 32px 48px}
    .asin-steps article:before{left:7px;right:auto;top:56px;bottom:-1px;width:2px;height:auto}
    .asin-steps article:last-child:before{display:none}
    .asin-steps span{top:16px;left:-8px}
    .asin-steps p{max-width:32ch}
    main>section.asin-value{min-height:auto!important;padding:88px 0!important}
    .asin-value__layout{display:block}
    .asin-value__number{padding:0}
    .asin-value h2{margin-top:20px;font-size:clamp(2.15rem,9.5vw,2.65rem)!important;line-height:1.04!important}
    .asin-value__statement{margin-top:28px;font-size:1.18rem}
    .asin-commerce-visual{margin-top:28px}
    .asin-attribution dl{grid-template-columns:1fr;gap:12px}
    .asin-network>div span{font-size:11px}.asin-network>p i{padding:7px 9px;font-size:11px}
    .asin-disclosure{margin-top:14px}
    .asin-fit__layout{grid-template-columns:1fr;gap:48px}
    .asin-fit__group ol{gap:14px}
    .asin-cta h2{font-size:clamp(2.45rem,10.5vw,3.6rem)!important}
    .asin-button{width:100%;justify-content:center}
  }
`
